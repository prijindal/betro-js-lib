...
const importAesKey = (key, keyUsage) => crypto.subtle.importKey("raw", Buffer.from(key, "base64"), "AES-CBC", false, keyUsage);
const importHmacKey = (key, keyUsage) => crypto.subtle.importKey("raw", Buffer.from(key, "base64"), HMAC_ALGORITHM, false, keyUsage);
export const aesEncrypt = async (encryption_key, encryption_mac, data) => {
...
export const aesDecrypt = async (encryption_key, encryption_mac, encrypted_data) => {
