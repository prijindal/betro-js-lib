...
const importAesKey = (key, keyUsage) => crypto_1.default.subtle.importKey("raw", Buffer.from(key, "base64"), "AES-CBC", false, keyUsage);
const importHmacKey = (key, keyUsage) => crypto_1.default.subtle.importKey("raw", Buffer.from(key, "base64"), HMAC_ALGORITHM, false, keyUsage);
